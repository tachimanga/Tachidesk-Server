 ...
 * override that.
 * Flink: https://github.com/apache/flink/tree/master/flink-core/src/main/java/org/apache/flink/util/ChildFirstClassLoader.java
            ...
            if (c == null) {
                ...
                for (String alwaysParentFirstPattern : alwaysParentFirstPatterns) {
                    if (name.startsWith(alwaysParentFirstPattern)) {
                        //System.out.println("[ext]loadClass by whitelist: " + name);
