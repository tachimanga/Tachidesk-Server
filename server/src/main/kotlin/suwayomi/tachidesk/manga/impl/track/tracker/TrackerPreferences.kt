...
class TrackerPreferences {
    ...
    fun setTrackCredentials(sync: Tracker, username: String, password: String) {
        println("setTrackCredentials: id=${sync.id} username=$username password=$password")
    ...
    fun setTrackToken(sync: Tracker, token: String?) {
        println("setTrackToken: id=${sync.id} token=$token")
        if (token == null) {
            preferenceStore.edit()
    ...
    fun setScoreType(sync: Tracker, scoreType: String) = preferenceStore.edit()
